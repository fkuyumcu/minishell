...
/*   Updated: 2025/04/30 16:20:39 by yalp             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	is_builtin(line_t *ml) // bool
{
	...
	return ( // bunları dene
		ft_strncmp(cmd, "echo", 6) == 0 || ft_strncmp(cmd, "cd", 6) == 0
			|| ft_strncmp(cmd, "pwd", 6) == 0 || ft_strncmp(cmd, "export",
				6) == 0 || ft_strncmp(cmd, "unset", 6) == 0 || ft_strncmp(cmd,
				"env", 6) == 0 || ft_strncmp(cmd, "exit", 6) == 0);
}
